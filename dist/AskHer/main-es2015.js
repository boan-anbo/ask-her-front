...
/* harmony import */ var ng_recaptcha__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ng-recaptcha */ "./node_modules/ng-recaptcha/__ivy_ngcc__/fesm2015/ng-recaptcha.js");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_auth_auth_guard_service__WEBPACK_IMPORTED_MODULE_18__["AuthGuard"]], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        _back_back_component__WEBPACK_IMPORTED_MODULE_4__["BackComponent"],
...
class AuthGuard {
    ...
    canActivate(next, state) {
        ...
        console.log(state);
        console.log(next);
        return this.dataService.checkAuth((_a = next.params) === null || _a === void 0 ? void 0 : _a.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(data => {
            console.log(data);
            if (data === false) {
                return false;
            }
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthGuard, [{
    ...
    }], function () { return [{ type: _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"] }]; }, null); })();
...
function BackComponent_mat_list_item_1_Template(rf, ctx) { if (rf & 1) {
...
function BackComponent_mat_list_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BackComponent_mat_list_item_2_Template_mat_icon_click_4_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r4); const item_r2 = ctx.$implicit; const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r3.approveUploadedAnswer(item_r2); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function BackComponent_mat_list_item_2_Template_mat_icon_click_7_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r4); const item_r2 = ctx.$implicit; const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r5.deleteUploadedAnswer(item_r2); });
...
class BackComponent {
    constructor(dataService, snackbar, authService) {
        this.dataService = dataService;
    ...
    approveUploadedAnswer(item) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.dataService.approveUploadedAnswer(item._id).subscribe((data) => {
                var _a;
                console.log(data);
                this.loadAllUploadedAnswers();
                this.snackbar.open(`Answer Approved: ${(_a = item.answer) === null || _a === void 0 ? void 0 : _a.message}`, '', { duration: 2000 });
            });
        });
    }
    deleteUploadedAnswer(item) {
        var _a, _b;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (window.confirm(`确定要删除吗（可按回车键确认）?\n ${(_a = item.answer) === null || _a === void 0 ? void 0 : _a.message}`)) {
                this.dataService.deleteUploadedAnswer(item._id).subscribe((data) => {
                    console.log(data);
                    this.loadAllUploadedAnswers();
                });
                this.snackbar.open(`Answer Deleted: ${(_b = item.answer) === null || _b === void 0 ? void 0 : _b.message}`, 'OK', { duration: 2000 });
            }
        });
    }
}
BackComponent.ɵfac = function BackComponent_Factory(t) { return new (t || BackComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"])); };
BackComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: BackComponent, selectors: [["app-back"]], decls: 3, vars: 2, consts: [["dense", ""], [4, "ngIf"], [4, "ngFor", "ngForOf"], ["mat-icon-button", "", "id", "approve"], [3, "click"], ["mat-icon-button", "", "id", "delete"]], template: function BackComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](BackComponent, [{
    ...
    }], function () { return [{ type: _data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }, { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"] }, { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }]; }, null); })();
...
class DataService {
    constructor(http) {
        ...
        // tslint:disable-next-line:variable-name
        this._listAllUpload = '/uploadanswer/listall';
        // tslint:disable-next-line:variable-name
        this._deleteUploadedAnswer = '/uploadanswer/delete/';
        // tslint:disable-next-line:variable-name
        this._approveUploadedAnswer = '/uploadanswer/approve/';
        // tslint:disable-next-line:variable-name
        this._backEntry = '/entry/back/';
        // tslint:disable-next-line:variable-name
        this._listAllEntries = '/entry/listall';
        // tslint:disable-next-line:variable-name
        this._getRandomEntry = '/entry/find/random';
        // tslint:disable-next-line:variable-name
        this._uploadAnswer = '/uploadanswer/';
        // tslint:disable-next-line:variable-name
        this._upvoteAnswer = '/upvote/answer/';
        // tslint:disable-next-line:variable-name
        this._upvoteQuestion = '/upvote/question/';
    }
    UpVoteAnswerUrl(answerId) {
        return this._apiBase + this._upvoteAnswer + answerId;
    }
    UpvoteQuestionUrl(questionId) {
        return this._apiBase + this._upvoteQuestion + questionId;
    }
    uploadQuestionUrl(questionId) {
        return this._apiBase + this._uploadAnswer + questionId;
    }
    getAllUpload() {
        return this.http.get(this._apiBase + this._listAllUpload);
    }
    deleteUploadedAnswer(id) {
        return this.http.get(this._apiBase + this._deleteUploadedAnswer + id);
    }
    approveUploadedAnswer(id) {
    ...
    uploadAnswer(questionId, message, authorId) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UploadAnswer", function() { return UploadAnswer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EntryCollection", function() { return EntryCollection; });
class Entry {
    constructor() {
        this.question = {
            text: '',
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _entry_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./entry.model */ "./src/app/main/entry.model.ts");
...
/* harmony import */ var _speech_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../speech.service */ "./src/app/speech.service.ts");
...
function MainComponent_mat_grid_tile_26_mat_card_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MainComponent_mat_grid_tile_26_mat_card_4_Template_button_click_13_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r16); const ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2); return ctx_r15.IUpVoteThat(); });
...
function MainComponent_mat_grid_tile_26_ng_template_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "p", 31);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1, "\u65E0\u4EBA\u56DE\u7B54");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} }
function MainComponent_mat_grid_tile_26_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MainComponent_mat_grid_tile_26_Template_button_click_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); const ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r17.LeftArrow(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MainComponent_mat_grid_tile_26_Template_button_click_7_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); const ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r19.RightArrow(); });
    ...
    const _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](6);
...
function MainComponent_ng_template_27_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function MainComponent_ng_template_27_Template_form_ngSubmit_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r24); const ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r23.submitHandler(); });
    ...
    const _r22 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](17);
...
function MainComponent_button_30_Template(rf, ctx) { if (rf & 1) {
    const _r26 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "button", 44);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MainComponent_button_30_Template_button_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r26); const ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r25.LetMeAnswer(); });
...
function MainComponent_ng_template_31_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MainComponent_ng_template_31_Template_button_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r28); const ctx_r27 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r27.ExitWritingMode(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "mat-icon");
...
class MainComponent {
    constructor(fb, dataService, snackbar, speechService) {
        this.fb = fb;
        this.dataService = dataService;
        this.snackbar = snackbar;
    ...
    IHeardThat() {
        if (this.alreadyHeard === false) {
            ...
            this.iHeardThatSubscription = this.dataService.UpvoteQuestion(this.currentEntry._id).subscribe((data) => console.log(data));
    ...
    IUpVoteThat() {
        if (!this.alreadyUpvoted[this.answerPointer.toString()]) {
            ...
            this.upvoteSubscription = this.dataService.UpvoteAnswer(this.currentEntry.answers[this.answerPointer].answerId).subscribe((data) => console.log(data));
            this.alreadyUpvoted[this.answerPointer.toString()] = true;
        }
    }
    addNewAnswer(message, authorId) {
        const newAnswer = new _entry_model__WEBPACK_IMPORTED_MODULE_2__["Answer"](message, authorId);
    ...
    PreLoadRandomQuestion() {
        this.preloadingSubscription = this.dataService.getOneRandomEntry().subscribe((data) => {
            ...
            (_a = this.preloadingSubscription) === null || _a === void 0 ? void 0 : _a.unsubscribe();
        });
    }
    UnsubscribeAll() {
        var _a, _b, _c, _d;
...
MainComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: MainComponent, selectors: [["app-main"]], decls: 33, vars: 8, consts: [["cols", "1", "rowHeight", "fit"], ["id", "question-tile", "rowspan", "5"], ["color", "accent"], ["id", "app-title-span"], ["id", "app-title-name"], ["id", "app-title-icon"], ["id", "question-title"], ["id", "question-author"], ["mat-button", "", "id", "heard-button", 3, "click"], ["id", "heard-text"], ["id", "heardNumber"], ["rowspan", "1"], ["mat-fab", "", "id", "next-answer", "color", "warn", 3, "disabled", "click"], ["id", "answer-tile", "rowspan", "4", 4, "ngIf", "ngIfElse"], ["writingPanel", ""], ["mat-flat-button", "", "id", "let-me-answer", "color", "accent", 3, "disabled", "click", 4, "ngIf", "ngIfElse"], ["cancelButton", ""], ["id", "answer-tile", "rowspan", "4"], ["mat-button", "", "id", "left-arrow", "color", "accent", 3, "disabled", "click"], [1, "arrow-button-icon"], ["id", "answer-card", 4, "ngIf", "ngIfElse"], ["noAnswer", ""], ["mat-button", "", "id", "right-arrow", "color", "accent", 3, "disabled", "click"], ["id", "answer-card"], ["id", "answer-message"], ["mat-flat-button", "", "disabled", "", "id", "answer-index-button"], ["id", "answer-index-current"], ["id", "answer-index-total"], ["mat-button", "", 3, "click"], ["id", "favorite"], ["id", "upVoteNumber"], ["id", "no-answer"], ["id", "writing-tile", "rowspan", "4"], ["ngNativeValidate", "", 1, "input-form", 3, "formGroup", "ngSubmit"], ["id", "inputText", 1, "input-full-width"], ["required", "", "matInput", "", "maxlength", "140", "placeholder", "\u6211\u60F3\u8BF4", "autocomplete", "off", "cdkTextareaAutosize", "", "cdkAutosizeMinRows", "1", "cdkAutosizeMaxRows", "5", "formControlName", "message"], ["message", "", "autosize", "cdkTextareaAutosize"], ["align", "start"], ["align", "end"], ["id", "inputId", 1, "input-full-width"], ["matInput", "", "maxlength", "20", "autocomplete", "on", "formControlName", "authorId", "value", "\u533F\u540D"], ["id", ""], ["id", "submit-button", "mat-stroked-button", "", 3, "disabled"], ["id", "submit-button-icon"], ["mat-flat-button", "", "id", "let-me-answer", "color", "accent", 3, "disabled", "click"], ["mat-flat-button", "", "color", "accent", "id", "cancel-writing-button", 3, "disabled", "click"]], template: function MainComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MainComponent_Template_button_click_17_listener($event) { return ctx.IHeardThat(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MainComponent_Template_button_click_23_listener($event) { return ctx.NextQuestion(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](MainComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] }, { type: _data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"] }, { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_6__["MatSnackBar"] }, { type: _speech_service__WEBPACK_IMPORTED_MODULE_7__["SpeechService"] }]; }, null); })();
...
SpeechService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: SpeechService, factory: SpeechService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SpeechService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
module.exports = __webpack_require__(/*! C:\Users\Bo\Dropbox\NEra\Script\Projects\AskHer\src\main.ts */"./src/main.ts");
